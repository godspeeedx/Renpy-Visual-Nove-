...
## внеигровым меню.
init -2:
    image qm_save = Animation("images/elements/q_m_save_h1.png",1)
    image qm_options = Animation("images/elements/q_m_options_h1.png",1)
    image qm_load = Animation("images/elements/q_m_load_h1.png",1)
    image qm_auto =Animation("images/elements/q_m_auto_h1.png",1)

screen quick_menu():

    ## Гарантирует, что оно появляется поверх других экранов.
    zorder 100
    imagebutton idle "images/elements/q_m_save_idle.png" hover "qm_save" xpos 1840  ypos 840 action  ShowMenu('save')
    imagebutton idle "images/elements/q_m_options_idle.png" hover "qm_options" xpos 1840   ypos 895 action ShowMenu('preferences')
    imagebutton idle "images/elements/q_m_load_idle.png" hover "qm_load" xpos 1840   ypos 947 action  ShowMenu('load')
    imagebutton idle "images/elements/q_m_auto_idle.png" hover "qm_auto" xpos 1840   ypos 1000 action  Preference("auto-forward", "toggle")
    if quick_menu:
...
## касаться.
##init -2:
##    image qm_save = Animation("images/elements/q_n_save_h1.png")
##    image qm_options = Animation("images/elements/q_n_options_h1.png")
##    image qm_load = Animation("images/elements/q_n_load_h1.png")
##    image qm_auto = Animation("images/elements/q_n_auto_h1.png")
screen quick_menu():
    variant "touch"
    ##zorder 100
##    imagebutton idle "images/elements/q_n_save_idle.png" hover "hover qm_save" xpos 1700  ypos 900 action  ShowMenu('save')
    ##imagebutton idle "images/elements/q_n_options_idle.png" hover "hover qm_options" xpos 1700  ypos 950 action ShowMenu('preferences')
##    imagebutton idle "images/elements/q_n_load_idle.png" hover "hover qm_load" xpos 1700  ypos 1000 action  ShowMenu('load')
##    imagebutton idle "images/elements/q_n_auto_idle.png" hover "hover qm_auto" xpos 1700  ypos 1050 action  Preference("auto-forward", "toggle")
    if quick_menu:
